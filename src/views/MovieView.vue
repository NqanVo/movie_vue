      ...
      <div class="md:col-span-2">
        <div class="">
          ...
          <p>
            ...
            <span v-for="companies in dataMovie.production_companies" :key="companies.id">{{ companies.name }}. </span>
          </p>
...
export default defineComponent({
  ...
  async mounted() {
    // try {
    //   this.dataMovie = await this.getDetailMovie()
    //   this.dataMovie.casts = await this.getCastMovie()
    // } catch (error) {}
